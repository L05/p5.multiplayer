...
const serverIp			= 'http://l05-play.herokuapp.com';	  // Server IP address
...
const touchMode			= 2;					            // 0 = touchPad, 1 = octoPad, 2 = segTrackPad
const segResolution = 3;                      // segTrackPad resolution
